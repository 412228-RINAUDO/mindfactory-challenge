...
export class CommentsController {
  ...
  async findByPostId(
    ...
    const { commentsDto, total } = 
      await this.commentsService.findByPostId(postId, finalPage, finalPageItems);

    return new PaginatedResponseDto(commentsDto, { page: finalPage, pageItems: finalPageItems, total });
  }
}
